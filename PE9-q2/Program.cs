...
namespace PE9_q2
{
    // Class: Program
    // Author: Max Lama
    // Purpose: Add timer to Math Quiz
    // Restrictions: None
    internal class Program
    {
        ...
        // Method: TimesUp
        // Purpose: Mark Answer wrong when time's up
        // Restrictions: None
        static void TimesUp(object sender, ElapsedEventArgs e)
        {
            ...
            Console.WriteLine("Please press enter for the next question.");
            bTimeOut = true;
            timeOutTimer.Stop();
        }
    }
