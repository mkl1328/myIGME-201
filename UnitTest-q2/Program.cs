...
namespace NumberSort
{
    ...
    class Program
    {
        ...
        // Method: Main
        // Purpose: Sort words alphabetically
        // Restrictions: None
        ...
        start:
            ...
            foreach (string sThisWord in sWord)
            {
                ...
                // Tests if the first char of a word is a letter
                if (Char.IsLetter(sThisWord[0]))
                {
                    ++nUnsortedLength;
                }
                else
            ...
            Console.Write("Ascending or Descending alphabetical order? ");
